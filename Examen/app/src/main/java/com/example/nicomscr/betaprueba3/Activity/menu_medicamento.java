...
import com.example.nicomscr.betaprueba3.Activity.MainActivity;
import com.example.nicomscr.betaprueba3.Fragments.Medicamento.F_AgregarM;
import com.example.nicomscr.betaprueba3.Fragments.Medicamento.F_Eliminar;
import com.example.nicomscr.betaprueba3.Fragments.Medicamento.F_ListaM;
import com.example.nicomscr.betaprueba3.Fragments.Medicamento.F_ModificarM;
import com.example.nicomscr.betaprueba3.Fragments.Medicamento.F_PresentacionM;
...
public class menu_medicamento extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        f.beginTransaction().replace(R.id.content_menu_medicamento, new F_PresentacionM()).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_agregarM) {
                f.beginTransaction().replace(R.id.content_menu_medicamento, new F_AgregarM()).commit();
            return true;

        } else if (id == R.id.nav_modificarM) {
            f.beginTransaction().replace(R.id.content_menu_medicamento, new F_ModificarM()).commit();
            return true;

        } else if (id == R.id.nav_listarM) {
            f.beginTransaction().replace(R.id.content_menu_medicamento, new F_ListaM()).commit();
            return true;

        } else if (id == R.id.nav_eliminarM) {
